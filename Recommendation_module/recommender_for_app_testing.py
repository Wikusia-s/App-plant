...
# to testowo żeby nie musieć wpisywać przy testowaniu z ręki
if __name__ == "__main__":
    json_path = "../plant_docs/plant_articles.json" 
    rec = PlantRecommender.from_json(json_path)

    seeds = ["Aloe vera", "Peace Lily"]
    print("Similar plants:", rec.similar_plants(seeds, top_k=5))

    uc = UserConstraints(light="low", water="low", pets_safe=True)
    print("By constraints:", rec.recommend_by_constraints(uc, top_k=5))

    print("Hybrid:", rec.hybrid_recommend(seeds, uc, top_k=5))
